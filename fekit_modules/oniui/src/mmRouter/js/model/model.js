...
function () {
    var todos = avalon.define('todos', function (vm) {
            ...
            vm.filter = function (todo) {
                if (vm.status == 'active')
                    return todo.completed.length == 0;
            ...
            vm.getClass = function (todo) {
                ...
                var className1 = todo.completed[0] == 'on' && 'completed' || '', className2 = todo === vm.editedTodo && 'editing' || '';
                return [
                    className1,
                    className2
                ].join(' ');
            ...
            vm.checkAll = function (len) {
                var all = todos.todos, remainingCount = !len.preventDefault ? len : all.length;
