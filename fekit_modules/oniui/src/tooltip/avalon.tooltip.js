    ...
    var widget = avalon.ui.tooltip = function (element, data, vmodels) {
            ...
            var vmodel = avalon.define(data.tooltipId, function (vm) {
                    ...
                    vm.show = function (elem) {
                        ...
                        if (elem) {
                            ofElement = elem;
                            var tipElem = avalon(tooltipElem), atEle = avalon(elem), tipElemAt = customAt, tipElemMy = customMy, bs = tooltipElem.getElementsByTagName('b'), arrOut, arrIn;
...
;
    ...
    widget.defaults = {
        ...
        container: void 0,
        //@config {Element} 把tooltip元素append到container指定的这个元素内
        width: 'auto',
